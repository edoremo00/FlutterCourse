...
import 'package:adv_basics/results_page_screen.dart';
...
class _QuizState extends State<Quiz> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget activeScreenWidget=StartScreen(switchscreenFn: switchScreen);
   switch (activeScreen) {
      case 'start-screen':
        StartScreen(switchscreenFn: switchScreen);
        break;
      case 'results-screen':
        activeScreenWidget=ResultsScreen(restartFn: restart,chosenAnswers: selectedAnswers,);
      break;
      default:
        activeScreenWidget=QuestionScreen(onSelectAnswer: addSelectedAnswer);
    }
